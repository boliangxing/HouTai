<?php if (!defined('THINK_PATH')) exit(); require_once('head.html'); ?>
        <section class="mainwarp">
            <article class="expand_query">
                <header>
                    <h2 style='font-size:16px'>0328维护前登录记录<span style='padding-left: 50px;'><a href="<?php echo WEB_ROOT?>index.php/User/login_record" style='color:#2996cc'>0328维护后登录记录</a></span></h2>
                </header>
                <form action="<?php echo WEB_ROOT?>index.php/User/login_record_old" method="GET">
					<span>请输入游戏ID：</span>
