<?php if (!defined('THINK_PATH')) exit(); require_once('head.html'); ?>
        <section class="mainwarp">
            <article class="expand_query">
                ...
                <div id="table_w">
				<span>当前有效转出：<?php echo ($zz_count); ?></span>
                <table id="num">
                    <thead>
                        <tr>
                            <th>日期</th>                            
    ...
    <footer>
        <ol class="pagination">
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userZz?pageNo=1" rel="next">首页</a></li>
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userZz?pageNo=<?php echo $pageNo-1<1?1:$pageNo-1 ?>" rel="prev">上页</a></li>
            <?php  if($pageNum>5){ if($pageNo<5){ for($i=1;$i<=5;$i++){?>
                    
                    <li class='page_no'><a href="<?php echo WEB_ROOT?>index.php/User/userZz?pageNo=<?php echo $i?>"><?php echo $i?></a></li>
			<?php  } ?>
					<li class='page_no'>......</li>
 ...
 for($i=1;$i<=$pageNum;$i++){?>
            ...
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userZz?pageNo=<?php echo $pageNo+1>$pageNum?$pageNum:$pageNo+1 ?>" rel="next">下页</a></li>
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userZz?pageNo=<?php echo $pageNum?>" rel="next">末页</a></li>
