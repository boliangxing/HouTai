...
<span style='padding-left20px;'>时间段：<?php echo ($start_date); ?>&nbsp;&nbsp;--&nbsp;&nbsp;<?php echo ($end_date); ?>&nbsp;&nbsp;&nbsp;&nbsp;下载次数:&nbsp;&nbsp;<?php echo ($xz); ?>&nbsp;&nbsp;&nbsp;&nbsp;注册帐号:&nbsp;&nbsp;<?php echo ($zc); ?>&nbsp;&nbsp;&nbsp;&nbsp;有效用户数量:&nbsp;&nbsp;<?php echo ($yx); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href='<?php echo WEB_ROOT?>index.php/User/tj_user?start_date=<?php echo $start_date;?>&end_date=<?php echo $end_date;?>'>实际用户</a></span>             
                <div id="table_w">
                <table id="num">
                    <thead>
                        <tr>
