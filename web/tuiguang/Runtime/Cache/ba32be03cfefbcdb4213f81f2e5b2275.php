<?php if (!defined('THINK_PATH')) exit(); require_once('head.html'); ?>
        <section class="mainwarp">
            <article class="expand_query">
                <header>
                    <h2>库存统计&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo WEB_ROOT?>index.php/User/suoyou"><span style="color:#2996cc">所有YS总<span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo WEB_ROOT?>index.php/User/all"><span style="color:#2996cc">所有人金币总<span></a></h2>
                </header>           
                <div id="table_w">
                    <span>当前库存：<?php echo ($cc_count); ?></span>
                <table id="num">
                    <thead>
                        <tr>
                            <th>日期</th>
    ...
    <footer>
        <ol class="pagination">
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userCc?pageNo=1" rel="next">首页</a></li>
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userCc?pageNo=<?php echo $pageNo-1<1?1:$pageNo-1 ?>" rel="prev">上页</a></li>
            <?php  if($pageNum>5){ if($pageNo<5){ for($i=1;$i<=5;$i++){?>
                    
                    <li class='page_no'><a href="<?php echo WEB_ROOT?>index.php/User/userCc?pageNo=<?php echo $i?>"><?php echo $i?></a></li>
			<?php  } ?>
					<li class='page_no'>......</li>
 ...
 for($i=1;$i<=$pageNum;$i++){?>
            ...
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userCc?pageNo=<?php echo $pageNo+1>$pageNum?$pageNum:$pageNo+1 ?>" rel="next">下页</a></li>
            <li><a href="<?php echo WEB_ROOT?>index.php/User/userCc?pageNo=<?php echo $pageNum?>" rel="next">末页</a></li>
