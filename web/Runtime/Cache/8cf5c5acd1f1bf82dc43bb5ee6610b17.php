...
<?php IF($_SESSION['zs78_admin2']['username']=='admin') { ?>
<a style='color:#2996cc' href="<?php echo WEB_ROOT?>index.php/User/regqdnum">添加渠道帐号</a>&nbsp;&nbsp;&nbsp;&nbsp;
 <?php } ?>
  ...
  <?php if(is_array($result)): foreach($result as $key=>$vo): ?><option value ="<?php echo ($vo["name"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
</select>
           <span>请输入渠道号：</span>
