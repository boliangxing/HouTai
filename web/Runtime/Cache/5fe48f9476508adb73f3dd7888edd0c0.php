<?php if (!defined('THINK_PATH')) exit(); require_once('head.html'); ?>
		<section class="mainwarp">
			<article class="addM">
				<header>
					<h2>添加首冲用户<span style="margin-left:30px;font-size:14px;"><a href="<?php echo WEB_ROOT?>index.php/User/tj_test"><span style="color:#2996cc;">推广点击</span></a></span><span style="margin-left:30px;font-size:14px;"><a href="<?php echo WEB_ROOT?>index.php/User/jiechi"><span style="color:#2996cc;">插图-扶翼</span></a></span></h2>
				</header>			
