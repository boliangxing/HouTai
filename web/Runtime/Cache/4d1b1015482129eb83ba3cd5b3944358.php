<?php if (!defined('THINK_PATH')) exit(); require_once('head.html'); ?>
        <section class="mainwarp">
            <article class="expand_query">
                <header>
                    <h2>uc新注册用户&nbsp;&nbsp;&nbsp;&nbsp;
                      <a style='color:#2996cc' href="<?php echo WEB_ROOT?>index.php/User/cz_uc">uc充值</a>
                      &nbsp;&nbsp;&nbsp;&nbsp;<a style='color:#2996cc' href="<?php echo WEB_ROOT?>index.php/User/zz_uc">uc转账
                      </a>&nbsp;&nbsp;&nbsp;&nbsp;
                      <a style='color:#2996cc' href="<?php echo WEB_ROOT?>index.php/User/userCount_uc">uc新注册用户统计</a></h2>
                </header>
				<form action="<?php echo WEB_ROOT?>index.php/User/newUser_uc" method="GET" style="padding:15px 198px 0">
                        <span>起止日期：&nbsp;&nbsp;</span>
