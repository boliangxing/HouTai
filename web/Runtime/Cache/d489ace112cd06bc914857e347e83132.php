                ...
                <table id="num">
                    ...
                    <tbody>
                       <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                            ...
                            <td><?php if($vo['loginFrom'] == 1): ?>IOS<?php endif; if($vo['loginFrom'] == 2): ?>ANDROID<?php endif; if($vo['loginFrom'] == 3): ?>PC<?php endif; if($vo['loginFrom'] == 4): ?>PC-XP<?php endif; if($vo['loginFrom'] == 5 OR $vo['loginFrom'] == 15): ?>5678<?php endif; if($vo['loginFrom'] == 9): ?>掌上老版本<?php endif; if($vo['loginFrom'] == 102): ?>ios捕鱼<?php endif; if($vo['loginFrom'] == 21): ?>zzlIOS<?php endif; if($vo['loginFrom'] == 22): ?>zzlAndroid<?php endif; if($vo['loginFrom'] == 23): ?>zzlPC<?php endif; if($vo['loginFrom'] == 25): ?>zzlWX<?php endif; if($vo['loginFrom'] == 51): ?>掌上捕鱼IOS<?php endif; if($vo['loginFrom'] == 52): ?>掌上捕鱼Android<?php endif; if($vo['loginFrom'] == 53): ?>掌上捕鱼PC<?php endif; ?></td>
