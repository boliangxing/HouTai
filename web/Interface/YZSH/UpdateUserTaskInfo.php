...
if(!$_POST['UserID'] || !$_POST['Random'] || !$_POST['Date'] || !$_POST['Sign'] || !$_POST['TaskID']){
	$return['error'] = '1';
...
if($Sign != $MySign){
	...
	$procedure = mssql_init("PHP_IF_UpdateUserTaskInfo",$conn); 
		mssql_bind($procedure,"RETVAL",$ret,SQLINT4,true);
		mssql_bind($procedure,"@dwUserID",$UserID,SQLINT4); 
		mssql_bind($procedure,"@iTaskID",$TaskID,SQLINT4);
